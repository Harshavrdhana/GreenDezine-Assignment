    ...
    <div className="flex w-screen h-auto">
      ...
      <div className="flex flex-col h-auto w-full bg-[#F5F7FA]">
        ...
        <div className="flex w-full h-full justify-between px-[40px] max-sm:px-[20px] pt-[40px] bg-[#F5F7FA]">
          <div className="w-full flex h-full max-xl:flex-col max-sm:overflow-hidden">
            <div className="w-[45vw] h-[200px] ">
              <Cards />
            </div>
            <div className=" w-full min-w-[320px] ml-[50px] max-xl:ml-[0px] max-xl:mt-[60px] h-[200px]">
              <Transaction />
            </div>
          </div>
        </div>
        <div className="w-full h-auto flex justify-start max-lg:flex-col">
          <div>
            ...
            <div className="w-[43vw] flex flex-col justify-center max-sm:min-w-[320px] h-auto bg-[white] ml-[40px] max-sm:ml-[20px] rounded-3xl mb-[20px]">
              <CustomBarChart />
            </div>
          </div>
          <div>
            <div className="w-[280px] flex justify-start items-center ml-[40px] max-sm:ml-[20px] h-[45px] pb-[15px]">
              <span className="items-center text-[#343C6A]">Weekly Activity</span>
            </div>
